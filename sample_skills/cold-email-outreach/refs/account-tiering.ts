export const slug = 'account-tiering'
export const title = 'Account Tiering, TAM Mapping & Pre-Warming'
export const triggers = ['tiering', 'tier 1', 'account research', 'tam', 'total addressable market', 'multichannel', 'pre-warm']
export const token_budget = 700
export const body = `
# Account Tiering, TAM Mapping & Pre-Warming

## 3 Starting Segments (Highest First-Campaign Reply Rate)
...
If budget allows, run LinkedIn ads to Tier 1 and Tier 2 account lists before sending a single email. When your name appears in their inbox, they have already seen it. The message does not feel completely cold.

Organic alternative: engage with target prospects' LinkedIn content (thoughtful comments on their posts) for 1-2 weeks before outreach. Goal: move from "never heard of you" to "I have seen that name before."
`
